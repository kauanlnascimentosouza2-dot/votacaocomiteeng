...
5. Em `ADMIN_EMAIL`, informe os e-mails administradores separados por vírgula.
...
- Somente os e-mails configurados em `ADMIN_EMAIL` acessam os votos identificados e cadastram propostas.
